...
export default function Sidebar({
	...
	>
		...
		/>
			...
			<section className="relative mx-1 rounded-[24px] border border-white/80 bg-gradient-to-br from-violet-100 via-fuchsia-50 to-blue-100 p-3.5 shadow-[0_14px_35px_rgba(124,58,237,0.13)]">
				<div
					aria-hidden="true"
				...
				<div className="relative flex items-center gap-3">
					...
					<div className="min-w-0">
						<p className="text-xs font-bold text-violet-600">Bonjour</p>
